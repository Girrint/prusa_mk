...
driver_SGTHRS: 48   # 255 is most sensitive value, 0 is least sensitiv      # Set to MCU pin connected to TMC DIAG pin
...
run_current: 0.75            # 0.65A hơi yếu nếu in nhanh. Thử 0.7A (nếu motor nóng quá thì giảm)
hold_current: 0.7
...
run_current: 0.75           # Tăng nhẹ lên 0.65A để giữ bàn in chắc hơn khi in nhanh
...
run_current: 0.75           # Đồng bộ dòng điện
hold_current: 0.7
...
mesh_pps: 3,3                 # tăng độ mịn nội suy 2,2 - 4,4
...
gcode:
  ...
  #G1 E-0.08 F1800      ; retract nhẹ
  #G1 X10 F3000        ; kéo đầu in qua 1 chút (wipe)
...
gcode:
    ...
    M140 S{temp}
    M190 S{temp}
    M118 Say nhua {temp}C

    UPDATE_DELAYED_GCODE ID=DRY_OFF_AUTO DURATION={time}

[delayed_gcode DRY_OFF_AUTO]
gcode:
    M140 S0
...
[gcode_macro LIVE_Z_TUNING]
description: Live Z tuning chuẩn (fix)
gcode:
    {% set BED = params.BED|default(60)|float %}
...
#*# version = 1
#*# points =
#*# 	  0.057215, -0.010285, 0.027215, 0.039715, 0.097215, 0.102215, 0.089715
#*# 	  0.042215, -0.015285, 0.017215, -0.007785, 0.062215, 0.082215, 0.064715
#*# 	  0.077215, 0.039715, 0.042215, 0.019715, 0.084715, 0.107215, 0.097215
#*# 	  0.072215, 0.037215, 0.007215, -0.007785, 0.094715, 0.149715, 0.122215
#*# 	  0.084715, 0.002215, 0.032215, 0.042215, 0.152215, 0.229715, 0.169715
#*# 	  -0.015285, -0.047785, 0.022215, 0.077215, 0.132215, 0.212215, 0.132215
#*# 	  -0.055285, -0.147785, 0.019715, 0.064715, 0.087215, 0.127215, 0.102215
#*# x_count = 7
#*# y_count = 7
#*# mesh_x_pps = 3
#*# mesh_y_pps = 3
...
#*# version = 1
#*# points =
#*# 	-0.048603, -0.126103, -0.056103, -0.043603, -0.003603, -0.008603, -0.016103
#*# 	-0.108603, -0.133603, -0.071103, -0.098603, -0.036103, -0.043603, -0.051103
#*# 	-0.053603, -0.093603, -0.056103, -0.076103, -0.006103, -0.003603, -0.021103
#*# 	-0.086103, -0.116103, -0.116103, -0.133603, -0.008603, 0.038897, 0.003897
#*# 	-0.113603, -0.131103, -0.068603, -0.078603, 0.048897, 0.123897, 0.066397
#*# 	-0.166103, -0.196103, -0.141103, -0.071103, 0.021397, 0.078897, 0.003897
#*# 	-0.216103, -0.223603, -0.163603, -0.106103, -0.053603, -0.001103, -0.061103
#*# x_count = 7
#*# y_count = 7
#*# mesh_x_pps = 3
#*# mesh_y_pps = 3
